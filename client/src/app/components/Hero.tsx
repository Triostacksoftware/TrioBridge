    ...
    <section className="bg-gradient-to-br from-[#f5f0ff] to-[#e3f0ff] min-h-[90vh] flex items-center">
      <div className="max-w-6xl mx-auto px-3 grid md:grid-cols-2 gap-y-12 items-center">
        ...
        <div className="space-y-6">
          ...
          {/* Headline */}
          <h1 className="text-4xl mt-3 md:text-[6.9vmin] font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-purple-700 to-blue-700 leading-normal lg:leading-normal">
          ...
          {/* Features */}
          <div className="flex space-x-20  mt-10 text-sm text-gray-600">
